import type { SavedItemWithDetails } from "../../lib/data/saved-items";
...
type SavedPageProps = {
  userSlug?: string;
  savedItems: SavedItemWithDetails[];
};

export function SavedPage({ userSlug, savedItems }: SavedPageProps) {
  return (
              ...
              <Card key={saved.id}>
                <CardHeader>
                  ...
                  <p className="text-sm text-muted-foreground">
                    {saved.feedItem.sourceConfig?.name ??
                      saved.feedItem.siteName ??
                      "Unknown source"}
                  </p>
                </CardHeader>
