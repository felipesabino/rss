      ...
      <div className="w-full max-w-4xl space-y-10 rounded-2xl border bg-white/80 p-10 shadow-xl backdrop-blur">
        <div className="space-y-3">
          ...
          <p className="max-w-2xl text-lg text-muted-foreground">
            This Next.js app is dedicated to the user-facing dashboard. UI,
            APIs, and data access will live here—completely separate from the
            generator pipeline and powered by shared packages for auth and data.
          </p>
        </div>
